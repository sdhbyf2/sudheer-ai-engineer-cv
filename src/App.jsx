...
export default function App(){
 ...
 <section id="home" className="hero" data-chapter="01">
  ...
  <div className="hero-content"><div className="eyebrow"><span className="status-dot"/> OPEN TO FULL-TIME AI ENGINEERING ROLES</div><h1>Sudheer<br/><span>Palakurla.</span></h1><div className="hero-editorial">AI engineer.<br/><em>Full-stack foundation.</em></div><p>I bring 8+ years of full-stack development experience, with hands-on work in document search, real-time voice AI, and cloud applications. I’m exploring my next full-time AI engineering role.</p><p className="hero-hiring-facts">London / 1 month notice / Sponsorship required</p><div className="hero-actions secondary-actions"><a href="/Sudheer_Palakurla_AI_Engineer_CV.pdf" className="button primary" download>Download CV <Download size={17}/></a><a className="text-link" href="#experience">View experience <ArrowUpRight size={15}/></a></div><div className="hero-actions"><button className="trailer-trigger" onClick={()=>setTrailer(true)}><span><Play size={13} fill="currentColor"/></span>Watch the introduction <small>{introDurationSeconds} SEC</small></button></div></div>
 ...
 <div className="credential-strip"><div><strong>8+ years</strong><span>FULL-STACK EXPERIENCE</span></div><div><strong>95+ builds</strong><span>DELIVERED OR CONTRIBUTED TO</span></div><div><strong>Master’s</strong><span>DATA SCIENCE & AI</span></div><a href="#contact"><span className="status-dot"/> OPEN TO FULL-TIME AI ENGINEERING ROLES <ArrowUpRight size={15}/></a></div>
 <section id="story" className="section story" data-chapter="02"><div className="section-kicker reveal"><span>THE PROFILE</span><span>CREATIVE THINKING. PRACTICAL ENGINEERING.</span></div><div className="story-grid"><div className="profile-title reveal"><h2>Thoughtful by nature.<br/><span>Engineer by craft.</span></h2><RoleFit/></div><div className="story-copy reveal"><p className="lead">I connect the intelligence inside a product with the experience people actually use.</p><p>My foundation is full-stack engineering: 8+ years across client applications, e-commerce, migrations, and technical leadership. Today, I apply that experience to production RAG, LLM routing, agentic workflows, and real-time voice AI.</p><div className="profile-facts" role="group" aria-label="Recruiter summary"><div><span>WHAT I BRING</span><p>End-to-end delivery, technical mentoring, and collaboration across product and engineering.</p></div><div><span>TARGET ROLES</span><p>AI Engineer, Applied AI Engineer, and LLM Engineer.</p></div></div><RecruiterDetails/><button className="profile-quick-link" onClick={()=>setQuickCV(true)}>The essentials, in two minutes <ArrowUpRight size={17}/></button></div></div></section>
