...
export default function Contact() {
 ...
 return <section id="contact" className="section contact" data-chapter="06">
  ...
  <div className="contact-bottom"><p>From architecture to the final interaction.<br/>Ready to own the whole challenge.</p><a href={linkedin} target="_blank" rel="noreferrer">LinkedIn <ArrowUpRight size={16}/></a><a href="https://github.com/sdhbyf2/sudheer-ai-engineer-cv" target="_blank" rel="noreferrer">Portfolio source <ArrowUpRight size={16}/></a><a href={cvUrl} download>Download CV <Download size={16}/></a></div>
 </section>;
}
